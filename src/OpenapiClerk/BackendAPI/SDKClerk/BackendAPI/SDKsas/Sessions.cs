...
namespace OpenapiClerk.BackendAPI.SDKClerk.BackendAPI.SDKsas
{
    ...
    public interface ISessions
    {
        ...
        /// </remarks>
        /// </summary>
        Task<CreateSessionTokenFromTemplateResponse> CreateTokenAsync(string sessionId, string templateName);
    }
    ...
    public class Sessions: ISessions
    {
        ...
        public Sessions(ISpeakeasyHttpClient client, Func<OpenapiClerk.BackendAPI.SDKClerk.BackendAPI.SDKsas.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<CreateSessionTokenFromTemplateResponse> CreateTokenAsync(string sessionId, string templateName)
        {
