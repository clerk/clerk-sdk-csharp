...
namespace OpenapiClerk.BackendAPI.SDKClerk.BackendAPI.SDKsas
{
    ...
    public class ClerkBackendApi: IClerkBackendApi
    {
        ...
        public ClerkBackendApi(string? bearerAuth = null, Func<string>? bearerAuthSource = null, int? serverIndex = null, string? serverUrl = null, Dictionary<string, string>? urlParams = null, ISpeakeasyHttpClient? client = null, RetryConfig? retryConfig = null)
        {
            ...
            {
                _securitySource = () => new OpenapiClerk.BackendAPI.SDKClerk.BackendAPI.SDKsas.Models.Components.Security() { BearerAuth = bearerAuthSource() };
            }
            else if(bearerAuth != null)
            {
                _securitySource = () => new OpenapiClerk.BackendAPI.SDKClerk.BackendAPI.SDKsas.Models.Components.Security() { BearerAuth = bearerAuth };
            }
