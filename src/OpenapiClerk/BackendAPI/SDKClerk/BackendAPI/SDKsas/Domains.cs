...
namespace OpenapiClerk.BackendAPI.SDKClerk.BackendAPI.SDKsas
{
    ...
    public class Domains: IDomains
    {
        ...
        public Domains(ISpeakeasyHttpClient client, Func<OpenapiClerk.BackendAPI.SDKClerk.BackendAPI.SDKsas.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
