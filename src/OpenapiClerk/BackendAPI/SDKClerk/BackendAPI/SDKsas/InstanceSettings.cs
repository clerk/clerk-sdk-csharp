...
namespace OpenapiClerk.BackendAPI.SDKClerk.BackendAPI.SDKsas
{
    ...
    public class InstanceSettings: IInstanceSettings
    {
        ...
        public InstanceSettings(ISpeakeasyHttpClient client, Func<OpenapiClerk.BackendAPI.SDKClerk.BackendAPI.SDKsas.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
