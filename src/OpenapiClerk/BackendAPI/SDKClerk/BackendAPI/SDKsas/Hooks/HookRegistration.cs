...
namespace OpenapiClerk.BackendAPI.SDKClerk.BackendAPI.SDKsas.Hooks
{
    /// <summary>
    ...
    public static class HookRegistration
    {
        ...
        /// </summary>
        /// <remarks>
        /// Add hooks by calling `OpenapiClerk.BackendAPI.SDKClerk.BackendAPI.SDKsas.Hooks.Register&lt;HookInterface&gt;(myHook);`
