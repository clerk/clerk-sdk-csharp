...
namespace OpenapiClerk.BackendAPI.SDKClerk.BackendAPI.SDKsas
{
    ...
    public interface IClients
    {
        ...
        /// </remarks>
        /// </summary>
        Task<VerifyClientResponse> VerifyAsync(VerifyClientRequestBody? request = null);
        ...
        /// </remarks>
        /// </summary>
        Task<GetClientResponse> GetAsync(string clientId);
    }
    ...
    public class Clients: IClients
    {
        ...
        public Clients(ISpeakeasyHttpClient client, Func<OpenapiClerk.BackendAPI.SDKClerk.BackendAPI.SDKsas.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<VerifyClientResponse> VerifyAsync(VerifyClientRequestBody? request = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
        ...
        public async Task<GetClientResponse> GetAsync(string clientId)
        {
