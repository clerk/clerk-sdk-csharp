...
//------------------------------------------------------------------------------
#nullable enable
namespace OpenapiClerk.BackendAPI.SDKClerk.BackendAPI.SDKsas.Utils
{
    using System;
    using System.Linq;
    ...
    public class Utilities
    {
        ...
        public static bool IsClass(object? o)
        {
            if (o == null)
                return false;
            return o.GetType().IsClass && (o.GetType().FullName ?? "").StartsWith("OpenapiClerk.BackendAPI.SDKClerk.BackendAPI.SDKsas.Models");
        }
