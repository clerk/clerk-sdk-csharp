...
namespace Clerk.BackendAPI.Models.Operations
{
    ...
    public class UpdateUserRequestBody
    {
        ...
        public UpdateUserPublicMetadata? PublicMetadata { get; set; }

        /// <summary>
        /// Metadata saved on the user, that is only visible to your Backend API
        /// </summary>
        [JsonProperty("private_metadata")]
        public UpdateUserPrivateMetadata? PrivateMetadata { get; set; }
        ...
        public UpdateUserUnsafeMetadata? UnsafeMetadata { get; set; }
