...
namespace Clerk.BackendAPI.Models.Components
{
    ...
    public class BiometricCredential
    {
        ...
        /// </summary>
        [JsonProperty("object")]
        public BiometricCredentialObject Object { get; set; } = default!;

        [JsonProperty("id")]
        public string Id { get; set; } = default!;

        [JsonProperty("platform")]
        public BiometricCredentialPlatform Platform { get; set; } = default!;
        ...
        public BiometricCredentialAlgorithm Algorithm { get; set; } = default!;

        [JsonProperty("status")]
        public BiometricCredentialStatus Status { get; set; } = default!;
