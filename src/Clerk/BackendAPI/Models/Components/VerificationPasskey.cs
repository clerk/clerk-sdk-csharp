...
namespace Clerk.BackendAPI.Models.Components
{
    ...
    {
        [JsonProperty("object")]
        public VerificationPasskeyVerificationObject? Object { get; set; }

        [JsonProperty("status")]
        public VerificationPasskeyVerificationStatus Status { get; set; } = default!;

        [JsonProperty("strategy")]
        public VerificationPasskeyVerificationStrategy Strategy { get; set; } = default!;
