...
namespace Clerk.BackendAPI.Models.Components
{
    ...
    /// </summary>
    public class CommerceSubscriptionItem2NextPaymentTotals
    {
        ...
        public CommerceSubscriptionItem2NextPaymentCredits? Credits { get; set; } = null;

        [JsonProperty("discounts")]
        public CommerceSubscriptionItem2NextPaymentDiscounts? Discounts { get; set; } = null;
    }
}