...
namespace Clerk.BackendAPI.Models.Components
{
    ...
    /// </summary>
    public class CommerceSubscriptionItem2Plan
    {
        /// <summary>
        /// String representing the object's type. Objects of the same type share the same value.
        /// </summary>
        [JsonProperty("object")]
        public CommerceSubscriptionItem2PlanObject Object { get; set; } = default!;
        ...
        public CommerceSubscriptionItem2Fee? Fee { get; set; }

        [JsonProperty("annual_monthly_fee", NullValueHandling = NullValueHandling.Include)]
        public CommerceSubscriptionItem2AnnualMonthlyFee? AnnualMonthlyFee { get; set; }

        [JsonProperty("annual_fee", NullValueHandling = NullValueHandling.Include)]
        public CommerceSubscriptionItem2AnnualFee? AnnualFee { get; set; }
        ...
        public List<FeatureResponse2> Features { get; set; } = default!;
