...
namespace Clerk.BackendAPI.Models.Components
{
    ...
    /// </summary>
    public class SchemasCommerceSubscriptionItemNextPaymentTotals
    {
        ...
        public SchemasCommerceSubscriptionItemNextPaymentCredits? Credits { get; set; } = null;

        [JsonProperty("discounts")]
        public SchemasCommerceSubscriptionItemNextPaymentDiscounts? Discounts { get; set; } = null;
    }
}