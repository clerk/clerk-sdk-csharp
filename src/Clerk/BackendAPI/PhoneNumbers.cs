...
namespace Clerk.BackendAPI
{
    ...
    public interface IPhoneNumbers
    {
        ...
        /// </remarks>
        /// </summary>
        Task<UpdatePhoneNumberResponse> UpdateAsync(string phoneNumberId, UpdatePhoneNumberRequestBody requestBody);
    }
    ...
    public class PhoneNumbers: IPhoneNumbers
    {
        ...
        public async Task<UpdatePhoneNumberResponse> UpdateAsync(string phoneNumberId, UpdatePhoneNumberRequestBody requestBody)
        {
