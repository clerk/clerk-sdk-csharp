...
namespace Clerk.BackendAPI
{
    ...
    public interface ISignUps
    {
        ...
        /// </remarks>
        /// </summary>
        Task<UpdateSignUpResponse> UpdateAsync(string id, UpdateSignUpRequestBody requestBody);
    }
    ...
    public class SignUps: ISignUps
    {
        ...
        public async Task<UpdateSignUpResponse> UpdateAsync(string id, UpdateSignUpRequestBody requestBody)
        {
