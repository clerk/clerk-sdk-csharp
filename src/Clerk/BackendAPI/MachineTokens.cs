...
namespace Clerk.BackendAPI
{
    ...
    public interface IMachineTokens
    {
        ...
        /// </remarks>
        /// </summary>
        Task<CreateMachineTokenResponse> CreateAsync(CreateMachineTokenRequestBody? request = null, RetryConfig? retryConfig = null);
    }

    public class MachineTokens: IMachineTokens
    {
        ...
        public MachineTokens(SDKConfig config)
        {
            SDKConfiguration = config;
        }

        public async Task<CreateMachineTokenResponse> CreateAsync(CreateMachineTokenRequestBody? request = null, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();

            var urlString = baseUrl + "/machine_tokens";
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "CreateMachineToken", new List<string> {  }, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<MachineToken>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Include);
                    var response = new CreateMachineTokenResponse()
                    {
