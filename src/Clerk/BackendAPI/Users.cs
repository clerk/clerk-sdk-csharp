...
namespace Clerk.BackendAPI
{
    ...
    public interface IUsers
    {
        ...
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="ClerkErrors">Request was not successful. Thrown when the API returns a 400, 401, 404, 409 or 422 response.</exception>
        /// <exception cref="SDKError">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        ...
        /// </summary>
        /// <remarks>
        /// Retrieves the current credit balance for the specified user.<br/>
        /// Credits can be applied during checkout to reduce the charge or automatically applied to upcoming recurring charges.
        /// </remarks>
        /// <param name="userId">The ID of the user whose credit balance to retrieve.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="GetUserBillingCreditBalanceResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">The required parameter <paramref name="userId"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="ClerkErrors">Request was not successful. Thrown when the API returns a 400, 401, 403, 404, 422 or 500 response.</exception>
        /// <exception cref="SDKError">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<GetUserBillingCreditBalanceResponse> GetBillingCreditBalanceAsync(
            string userId,
            RetryConfig? retryConfig = null
        );
        ...
        /// </summary>
        /// <remarks>
        /// Increases or decreases the credit balance for the specified user.<br/>
        /// Each adjustment is recorded as a ledger entry. The idempotency_key parameter<br/>
        /// ensures that duplicate requests are safely handled.
        /// </remarks>
        /// <param name="userId">The ID of the user whose credit balance to adjust.</param>
        /// <param name="adjustCreditBalanceRequest">Parameters for the credit balance adjustment.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="AdjustUserBillingCreditBalanceResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">One of <paramref name="userId"/> or <paramref name="adjustCreditBalanceRequest"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        ...
        /// <exception cref="SDKError">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<AdjustUserBillingCreditBalanceResponse> AdjustBillingCreditBalanceAsync(
            string userId,
        ...
        /// </summary>
        /// <remarks>
        /// Removes the password credential from the given user. This is a privileged operation and does not require the user's current password. Password removal is allowed even when the user has no other sign-in method configured.<br/>
        /// <br/>
        ...
        /// </remarks>
        /// <param name="userId">The ID of the user whose password to remove.</param>
        /// <param name="requestBody">A <see cref="RemoveUserPasswordRequestBody"/> parameter.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="RemoveUserPasswordResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">The required parameter <paramref name="userId"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        ...
        /// <exception cref="SDKError">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<RemoveUserPasswordResponse> RemovePasswordAsync(
            string userId,
            RemoveUserPasswordRequestBody? requestBody = null,
            RetryConfig? retryConfig = null
        );
        ...
        /// </remarks>
        /// <param name="userId">The ID of the user whose trusted devices are returned.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="ListUserTrustedDevicesResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">The required parameter <paramref name="userId"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="ClerkErrors">Authorization invalid. Thrown when the API returns a 403, 404 or 500 response.</exception>
        ...
        public  Task<ListUserTrustedDevicesResponse> ListTrustedDevicesAsync(
            string userId,
            RetryConfig? retryConfig = null
        );
        ...
        /// </remarks>
        /// <param name="userId">The ID of the user that owns the trusted device.</param>
        /// <param name="trustedDeviceId">The ID of the trusted device to revoke.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="RevokeUserTrustedDeviceResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">One of <paramref name="userId"/> or <paramref name="trustedDeviceId"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="ClerkErrors">Authorization invalid. Thrown when the API returns a 403, 404 or 500 response.</exception>
        /// <exception cref="SDKError">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        [Obsolete("This method will be removed in a future release, please migrate away from it as soon as possible")]
        public  Task<RevokeUserTrustedDeviceResponse> RevokeTrustedDeviceAsync(
            string userId,
        ...
        /// </remarks>
        /// <param name="userId">The ID of the user whose biometric credentials are returned.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="ListUserBiometricCredentialsResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">The required parameter <paramref name="userId"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="ClerkErrors">Authorization invalid. Thrown when the API returns a 403, 404 or 500 response.</exception>
        /// <exception cref="SDKError">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<ListUserBiometricCredentialsResponse> ListBiometricCredentialsAsync(
            string userId,
            RetryConfig? retryConfig = null
        );
        ...
        /// </remarks>
        /// <param name="userId">The ID of the user that owns the biometric credential.</param>
        /// <param name="biometricCredentialId">The ID of the biometric credential to revoke.</param>
        /// <param name="retryConfig">The retry configuration to use for this operation.</param>
        /// <returns>An awaitable task that returns a <see cref="RevokeUserBiometricCredentialResponse"/> response envelope when completed.</returns>
        /// <exception cref="ArgumentNullException">One of <paramref name="userId"/> or <paramref name="biometricCredentialId"/> is null.</exception>
        /// <exception cref="HttpRequestException">The HTTP request failed due to network issues.</exception>
        /// <exception cref="ResponseValidationException">The response body could not be deserialized.</exception>
        /// <exception cref="ClerkErrors">Authorization invalid. Thrown when the API returns a 403, 404 or 500 response.</exception>
        /// <exception cref="SDKError">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public  Task<RevokeUserBiometricCredentialResponse> RevokeBiometricCredentialAsync(
            string userId,
    ...
    public class Users: IUsers
    {
        ...
        )
        {
            ...
            else if(new List<int>{400, 401, 404, 409, 422}.Contains(responseStatusCode))
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var httpResponseBody = await httpResponse.Content.ReadAsStringAsync();
        ...
        /// <exception cref="ClerkErrors">Request was not successful. Thrown when the API returns a 400, 401, 403, 404, 422 or 500 response.</exception>
        /// <exception cref="SDKError">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<GetUserBillingCreditBalanceResponse> GetBillingCreditBalanceAsync(
            string userId,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var request = new GetUserBillingCreditBalanceRequest()
            {
                UserId = userId,
            };

            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/users/{user_id}/billing/credits", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "GetUserBillingCreditBalance", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<CommerceCreditBalanceResponse>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into CommerceCreditBalanceResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new GetUserBillingCreditBalanceResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
                    ...
                    response.CommerceCreditBalanceResponse = obj;
                    return response;
                }
        ...
        /// <exception cref="ClerkErrors">Request was not successful. Thrown when the API returns a 400, 401, 403, 404, 409, 422 or 500 response.</exception>
        /// <exception cref="SDKError">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<AdjustUserBillingCreditBalanceResponse> AdjustBillingCreditBalanceAsync(
            string userId,
            AdjustCreditBalanceRequest adjustCreditBalanceRequest,
            RetryConfig? retryConfig = null
        )
        {
            if (userId == null) throw new ArgumentNullException(nameof(userId));
            if (adjustCreditBalanceRequest == null) throw new ArgumentNullException(nameof(adjustCreditBalanceRequest));

            var request = new AdjustUserBillingCreditBalanceRequest()
            {
                UserId = userId,
                AdjustCreditBalanceRequest = adjustCreditBalanceRequest,
            };
            ...
            var serializedBody = RequestBodySerializer.Serialize(request, "AdjustCreditBalanceRequest", "json", false, false);
            if (serializedBody != null)
            {
                httpRequest.Content = serializedBody;
            }
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "AdjustUserBillingCreditBalance", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<CommerceCreditLedgerResponse>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into CommerceCreditLedgerResponse.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new AdjustUserBillingCreditBalanceResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
                    ...
                    response.CommerceCreditLedgerResponse = obj;
                    return response;
                }
        ...
        /// <exception cref="ClerkErrors">Request was not successful. Thrown when the API returns a 400, 401, 403, 404 or 500 response.</exception>
        /// <exception cref="SDKError">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<RemoveUserPasswordResponse> RemovePasswordAsync(
            string userId,
            RemoveUserPasswordRequestBody? requestBody = null,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var request = new RemoveUserPasswordRequest()
            {
                UserId = userId,
                RequestBody = requestBody,
            };
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/users/{user_id}/remove_password", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "RemoveUserPassword", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new RemoveUserPasswordResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
        ...
        /// <exception cref="SDKError">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        [Obsolete("This method will be removed in a future release, please migrate away from it as soon as possible")]
        public async  Task<ListUserTrustedDevicesResponse> ListTrustedDevicesAsync(
            string userId,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var request = new ListUserTrustedDevicesRequest()
            {
                UserId = userId,
            };

            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/users/{user_id}/trusted_devices", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ListUserTrustedDevices", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var httpResponseBody = await httpResponse.Content.ReadAsStringAsync();
                    TrustedDeviceList obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<TrustedDeviceList>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into TrustedDeviceList.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new ListUserTrustedDevicesResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
                    ...
                    response.TrustedDeviceList = obj;
                    return response;
                }
        ...
        /// <exception cref="SDKError">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        [Obsolete("This method will be removed in a future release, please migrate away from it as soon as possible")]
        public async  Task<RevokeUserTrustedDeviceResponse> RevokeTrustedDeviceAsync(
            string userId,
            string trustedDeviceId,
            RetryConfig? retryConfig = null
        )
        {
            if (userId == null) throw new ArgumentNullException(nameof(userId));
            if (trustedDeviceId == null) throw new ArgumentNullException(nameof(trustedDeviceId));

            var request = new RevokeUserTrustedDeviceRequest()
            {
                UserId = userId,
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/users/{user_id}/trusted_devices/{trusted_device_id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "RevokeUserTrustedDevice", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<TrustedDevice>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into TrustedDevice.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new RevokeUserTrustedDeviceResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
        ...
        /// <exception cref="ClerkErrors">Authorization invalid. Thrown when the API returns a 403, 404 or 500 response.</exception>
        /// <exception cref="SDKError">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<ListUserBiometricCredentialsResponse> ListBiometricCredentialsAsync(
            string userId,
            RetryConfig? retryConfig = null
        )
        {
            ...
            var request = new ListUserBiometricCredentialsRequest()
            {
                UserId = userId,
            };

            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/users/{user_id}/biometric_credentials", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ListUserBiometricCredentials", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var httpResponseBody = await httpResponse.Content.ReadAsStringAsync();
                    BiometricCredentialList obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<BiometricCredentialList>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into BiometricCredentialList.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new ListUserBiometricCredentialsResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
                    ...
                    response.BiometricCredentialList = obj;
                    return response;
                }
        ...
        /// <exception cref="ClerkErrors">Authorization invalid. Thrown when the API returns a 403, 404 or 500 response.</exception>
        /// <exception cref="SDKError">Default API Exception. Thrown when the API returns a 4XX or 5XX response.</exception>
        public async  Task<RevokeUserBiometricCredentialResponse> RevokeBiometricCredentialAsync(
            string userId,
            string biometricCredentialId,
            RetryConfig? retryConfig = null
        )
        {
            if (userId == null) throw new ArgumentNullException(nameof(userId));
            if (biometricCredentialId == null) throw new ArgumentNullException(nameof(biometricCredentialId));

            var request = new RevokeUserBiometricCredentialRequest()
            {
                UserId = userId,
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/users/{user_id}/biometric_credentials/{biometric_credential_id}", request, null);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "RevokeUserBiometricCredential", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var httpResponseBody = await httpResponse.Content.ReadAsStringAsync();
                    BiometricCredential obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<BiometricCredential>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into BiometricCredential.", httpRequest, httpResponse, httpResponseBody, ex);
                    }

                    var response = new RevokeUserBiometricCredentialResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
                    ...
                    response.BiometricCredential = obj;
                    return response;
                }
