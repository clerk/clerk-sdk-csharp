...
namespace Clerk.BackendAPI
{
    ...
    public interface IAwsCredentials
    {
        ...
        /// </remarks>
        /// </summary>
        Task<GetAWSCredentialListResponse> ListAsync(RetryConfig? retryConfig = null);
        ...
        /// </remarks>
        /// </summary>
        Task<CreateAWSCredentialResponse> CreateAsync(CreateAWSCredentialRequestBody? request = null, RetryConfig? retryConfig = null);
        ...
        /// </remarks>
        /// </summary>
        Task<GetAWSCredentialResponse> GetAsync(string id, RetryConfig? retryConfig = null);
    ...
    public class AwsCredentials: IAwsCredentials
    {
        ...
        public async Task<GetAWSCredentialListResponse> ListAsync(RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();

            var urlString = baseUrl + "/aws_credentials";
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "GetAWSCredentialList", new List<string> {  }, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                ...
                {
                    var obj = ResponseBodyDeserializer.Deserialize<List<AWSCredential>>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Ignore);
                    var response = new GetAWSCredentialListResponse()
                    {
                    ...
                    response.AWSCredentialList = obj;
                    return response;
                }
        ...
        public async Task<CreateAWSCredentialResponse> CreateAsync(CreateAWSCredentialRequestBody? request = null, RetryConfig? retryConfig = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "CreateAWSCredential", new List<string> {  }, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    var obj = ResponseBodyDeserializer.Deserialize<AWSCredential>(await httpResponse.Content.ReadAsStringAsync(), NullValueHandling.Include);
                    var response = new CreateAWSCredentialResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
        ...
        public async Task<GetAWSCredentialResponse> GetAsync(string id, RetryConfig? retryConfig = null)
        {
            var request = new GetAWSCredentialRequest()
            {
                Id = id,
            };
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "GetAWSCredential", new List<string> {  }, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new GetAWSCredentialResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
