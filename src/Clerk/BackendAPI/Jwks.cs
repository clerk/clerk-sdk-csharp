...
namespace Clerk.BackendAPI
{
    ...
    public interface IJwks
    {
        ...
        /// <returns>An awaitable task that returns a <see cref="GetJWKSResponse"/> response envelope when completed.</returns>
        ...
        public  Task<GetJWKSResponse> GetJWKSAsync(RetryConfig? retryConfig = null);
    }
    ...
    public class Jwks: IJwks
    {
        ...
        public async  Task<GetJWKSResponse> GetJWKSAsync(RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "GetJWKS", null, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    Models.Components.Jwks obj;
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<Models.Components.Jwks>(httpResponseBody, NullValueHandling.Ignore);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into Models.Components.Jwks.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
