...
namespace Clerk.BackendAPI
{
    ...
    public interface ICommerce
    {
        ...
        /// 
        /// <remarks>
        /// Returns a list of all commerce plans for the instance. The plans are returned sorted by creation date,<br/>
        ...
        /// </remarks>
        /// </summary>
        Task<ExtendCommerceSubscriptionItemFreeTrialResponse> ExtendSubscriptionItemFreeTrialAsync(string subscriptionItemId, ExtendFreeTrialRequest extendFreeTrialRequest, RetryConfig? retryConfig = null);
    }
    ...
    public class Commerce: ICommerce
    {
        ...
        public async Task<GetCommercePlanListResponse> ListPlansAsync(bool? paginated = null, long? limit = 10, long? offset = 0, PayerType? payerType = null, RetryConfig? retryConfig = null)
        {
            ...
            var urlString = URLBuilder.Build(baseUrl, "/commerce/plans", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "GetCommercePlanList", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/commerce/subscription_items", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "GetCommerceSubscriptionItemList", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task<CancelCommerceSubscriptionItemResponse> CancelSubscriptionItemAsync(string subscriptionItemId, bool? endNow = false, RetryConfig? retryConfig = null)
        {
            ...
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
            var urlString = URLBuilder.Build(baseUrl, "/commerce/subscription_items/{subscription_item_id}", request);
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "CancelCommerceSubscriptionItem", new List<string> {  }, SDKConfiguration.SecuritySource);
        ...
        public async Task<ExtendCommerceSubscriptionItemFreeTrialResponse> ExtendSubscriptionItemFreeTrialAsync(string subscriptionItemId, ExtendFreeTrialRequest extendFreeTrialRequest, RetryConfig? retryConfig = null)
        {
            var request = new ExtendCommerceSubscriptionItemFreeTrialRequest()
            {
                SubscriptionItemId = subscriptionItemId,
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "ExtendCommerceSubscriptionItemFreeTrial", new List<string> {  }, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    var response = new ExtendCommerceSubscriptionItemFreeTrialResponse()
                    {
                        HttpMeta = new Models.Components.HTTPMetadata()
                        {
                            Response = httpResponse,
