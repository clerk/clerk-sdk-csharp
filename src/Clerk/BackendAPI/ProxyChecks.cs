...
namespace Clerk.BackendAPI
{
    ...
    public class ProxyChecks: IProxyChecks
    {
        ...
        public async Task<VerifyDomainProxyResponse> VerifyAsync(VerifyDomainProxyRequestBody? request = null, RetryConfig? retryConfig = null)
        {
            ...
            var hookCtx = new HookContext(SDKConfiguration, baseUrl, "VerifyDomainProxy", new List<string> {  }, SDKConfiguration.SecuritySource);
            ...
            if(responseStatusCode == 200)
            {
                if(Utilities.IsContentTypeMatch("application/json", contentType))
                {
                    ...
                    try
                    {
                        obj = ResponseBodyDeserializer.DeserializeNotNull<ProxyCheck>(httpResponseBody, NullValueHandling.Include);
                    }
                    catch (Exception ex)
                    {
                        throw new ResponseValidationException("Failed to deserialize response body into ProxyCheck.", httpRequest, httpResponse, httpResponseBody, ex);
                    }
