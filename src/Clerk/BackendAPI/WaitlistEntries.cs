...
namespace Clerk.BackendAPI
{
    ...
    public interface IWaitlistEntries
    {
        ...
        /// </remarks>
        /// </summary>
        Task<ListWaitlistEntriesResponse> ListWaitlistEntriesAsync(ListWaitlistEntriesRequest? request = null);
        ...
        /// </remarks>
        /// </summary>
        Task<CreateWaitlistEntryResponse> CreateWaitlistEntryAsync(CreateWaitlistEntryRequestBody? request = null);
    }
    ...
    public class WaitlistEntries: IWaitlistEntries
    {
        ...
        public async Task<ListWaitlistEntriesResponse> ListWaitlistEntriesAsync(ListWaitlistEntriesRequest? request = null)
        {
        ...
        public async Task<CreateWaitlistEntryResponse> CreateWaitlistEntryAsync(CreateWaitlistEntryRequestBody? request = null)
        {
            string baseUrl = this.SDKConfiguration.GetTemplatedServerUrl();
