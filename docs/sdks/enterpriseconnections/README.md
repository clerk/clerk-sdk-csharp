...
| Error Type                                 | Status Code                                | Content Type                               |
| ------------------------------------------ | ------------------------------------------ | ------------------------------------------ |
| Clerk.BackendAPI.Models.Errors.ClerkErrors | 402, 403, 404, 409, 422                    | application/json                           |
| Clerk.BackendAPI.Models.Errors.SDKError    | 4XX, 5XX                                   | \*/\*                                      |
...
<!-- UsageSnippet language="csharp" operationID="ListEnterpriseConnectionTestRuns" method="get" path="/enterprise_connections/{enterprise_connection_id}/test_runs" -->
```csharp
using Clerk.BackendAPI;
using Clerk.BackendAPI.Models.Components;
...
var res = await sdk.EnterpriseConnections.ListTestRunsAsync(
    enterpriseConnectionId: "<id>",
    limit: 20,
    offset: 10
);
...
<!-- UsageSnippet language="csharp" operationID="CreateEnterpriseConnectionTestRun" method="post" path="/enterprise_connections/{enterprise_connection_id}/test_runs" -->
```csharp
using Clerk.BackendAPI;
using Clerk.BackendAPI.Models.Components;
...
var res = await sdk.EnterpriseConnections.CreateTestRunAsync(enterpriseConnectionId: "<id>");
